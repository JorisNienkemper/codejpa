...
public class EmployeeManyToOne {
    ...
    @ManyToOne// show default behavior (fetch = FetchType.EAGER)
    private PublisherOneToMany publisher;

    public EmployeeManyToOne() {
    }

    public EmployeeManyToOne(String firstname, String middleInitial, String lastname, Date hireDate) {
    ...
    public boolean equals(Object o) {
        ...
        EmployeeManyToOne employee = (EmployeeManyToOne) o;
